...
e.minimize=function(a){if(!1===a)return this.restore();I&&Aa();this.max&&(this.removeClass("max"),this.max=!1);if(!this.min){w.push(this);ma();this.g.title=this.title;this.addClass("min");this.min=!0;a=x.length;if(1<a)for(var b=1;b<=a;b++){var c=x[a-b];if(!c.min){c.focus();break}}else this.blur();this.onminimize&&this.onminimize()}return this};

...
e.minimize=function(a){if(!1===a)return this.restore();G&&Z();this.max&&(this.removeClass("max"),this.max=!1);this.min||(A.push(this),W(),this.g.title=this.title,this.addClass("min"),this.min=!0,this.onminimize&&this.onminimize());return this};e.restore=function(){G&&Z();this.min&&(Y(this),this.resize().move(),this.onrestore&&this.onrestore());this.max&&(this.max=!1,this.removeClass("max").resize().move(),this.onrestore&&this.onrestore());return this};
e.maximize=function(a){if(!1===a)return this.restore();G&&Z();this.min&&Y(this);this.max||(this.addClass("max").resize(Q-this.left-this.right,R-this.top-this.bottom,!0).move(this.left,this.top,!0),this.max=!0,this.onmaximize&&this.onmaximize());return this};e.fullscreen=function(a){this.min&&(Y(this),this.resize().move());if(!G||!Z())this.body[I](),G=this,this.full=!0,this.onfullscreen&&this.onfullscreen();else if(!1===a)return this.restore();return this};
function Z(){G.full=!1;if(document.fullscreen||document.fullscreenElement||document.webkitFullscreenElement||document.mozFullScreenElement)return document[P](),!0}e.close=function(a){if(this.onclose&&this.onclose(a))return!0;this.min&&Y(this);this.unmount();this.g.parentNode.removeChild(this.g);this.g.textContent="";this.g=this.body=this.g.winbox=null;H===this&&(H=null)};
e.move=function(a,b,c){a||0===a?c||(this.x=a?a=V(a,Q-this.left-this.right,this.width):0,this.y=b?b=V(b,R-this.top-this.bottom,this.height):0):(a=this.x,b=this.y);z(this.g,"transform","translate("+a+"px,"+b+"px)");this.onmove&&this.onmove(a,b);return this};
e.resize=function(a,b,c){a||0===a?c||(this.width=a?a=V(a,Q-this.left-this.right):0,this.height=b?b=V(b,R-this.top-this.bottom):0,a=Math.max(a,this.j),b=Math.max(b,this.i)):(a=this.width,b=this.height);z(this.g,"width",a+"px");z(this.g,"height",b+"px");this.onresize&&this.onresize(a,b);return this};e.addClass=function(a){this.g.classList.add(a);return this};e.removeClass=function(a){this.g.classList.remove(a);return this};
e.toggleClass=function(a){return this.g.classList.contains(a)?this.removeClass(a):this.addClass(a)};window.WinBox=U;}).call(this);
